...
start:
	...
	cd subclip-video-formatter && $(DOCKER_COMPOSE) up -d && cd ..
...
stop:
	...
	cd subclip-video-formatter && $(DOCKER_COMPOSE) down --remove-orphans && cd ..
...
build: 
	...
	cd subclip-video-formatter && $(DOCKER_COMPOSE) build --pull --no-cache && cd ..
...
fix:
	...
	cd subclip-video-formatter && make fix && cd ..
...
protobuf:
	...
	cp subclip-protobuf/Message.proto subclip-video-formatter 
	...
	rm -r subclip-video-formatter/Message.proto
